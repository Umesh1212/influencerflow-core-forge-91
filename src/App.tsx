      ...
      <BrowserRouter>
        <Routes>
          <Route path="/" element={<Layout />}>
            ...
            <Route path="discovery" element={<div className="text-center py-12 text-secondary">Discovery page coming soon</div>} />
            <Route path="inbox" element={<div className="text-center py-12 text-secondary">Inbox page coming soon</div>} />
